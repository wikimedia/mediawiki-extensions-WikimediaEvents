...
class UserLoginInstrumentationAuthenticationRequest extends AuthenticationRequest {
	public const NAME = 'wmevents_userlogin_noscript';
	 ...
	 * @var string|null
	 */
	public ?string $wmevents_userlogin_noscript;
