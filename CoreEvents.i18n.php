 ...
 */
$messages['en'] = array(
	'coreevents-desc' => 'Use EventLogging extension to log events that occur in core MediaWiki',
);
 ...
 */
$messages['fa'] = array(
	'coreevents-desc' => 'از افزونهٔ سیاههٔ رویدادها استفاده کنید تا سیاههٔ رویدادهای اتفاق افتاده در هستهٔ مدیاویکی تهیه شود',
);
