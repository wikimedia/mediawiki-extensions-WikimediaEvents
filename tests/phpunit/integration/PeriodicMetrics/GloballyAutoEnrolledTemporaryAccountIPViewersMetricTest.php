...
/**
 * @group Database
 * @covers \WikimediaEvents\PeriodicMetrics\GloballyAutoEnrolledTemporaryAccountIPViewersMetric
 */
class GloballyAutoEnrolledTemporaryAccountIPViewersMetricTest extends MediaWikiIntegrationTestCase {
	...
	private function getObjectUnderTest() {
		...
		return $metricsFactory->newMetric( GloballyAutoEnrolledTemporaryAccountIPViewersMetric::class );
	}
	...
	public function testGetName() {
		$this->assertSame(
			'globally_auto_enrolled_temporary_account_ip_viewers_total',
